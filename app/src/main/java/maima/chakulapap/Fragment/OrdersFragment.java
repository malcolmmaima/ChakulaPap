...
import maima.chakulapap.AdapterOrders;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://dev.oscorpltd.com/FetchOrders.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length() - 1; i++) { //We need the minus one since our json returns an empty object t the end of the list
                    ...
                    fishData.fishImage = json_data.getString("order_img");
                    fishData.fishName = json_data.getString("order_name");
                    fishData.catName = json_data.getString("order_cat");
                    fishData.sizeName = json_data.getString("order_size");
                    fishData.price = json_data.getInt("order_price");
                    fishData.customerName = json_data.getString("customer_name");
                    data.add(fishData);
                }

                int orders = jArray.length(); //Need to pass this value to my provider activity

                // Setup and Handover data to recyclerview
                mRVFishPrice = (RecyclerView) getView().findViewById(R.id.fishPriceList);
                mAdapter = new AdapterOrders(getContext(), data);
