...
import maima.chakulapap.AdapterMyMenu;
...
public class MyMenu extends Fragment {
    ...
    private AdapterMyMenu mAdapter;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                // Lets make a call to php file which returns json data
                url = new URL("http://dev.oscorpltd.com/FetchMyMenu.php"); //Change this to FetchExtras.php file once created
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                /**
                 * We need to grab the name of the logged in user so that we can filter the menu to display
                 * the stuff he/she has uploaded and not menu items by other providers
                 */
                Intent in = getActivity().getIntent();
                String providerName= in.getExtras().getString("Welcome");
                ...
                for (int i = 0; i < jArray.length() - 1; i++) {//We need the minus one since our json returns an empty object t the end of the list
                        ...
                        fishData.providerName = json_data.getString("provider_name");
                        data.add(fishData);
                ...
                mAdapter = new AdapterMyMenu(getContext(), data);
