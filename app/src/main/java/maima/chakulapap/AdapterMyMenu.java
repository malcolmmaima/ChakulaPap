...
public class AdapterMyMenu extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterMyMenu(Context context, List<DataFood> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.container_my_menu, parent,false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        myHolder.order_button.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(final View view){
                ...
                AlertDialog myQuittingDialogBox = new AlertDialog.Builder(view.getContext())
                        ...
                        .setTitle("Edit "+current.fishName)
                        .setMessage("Are you sure you want to edit "+ current.fishName + "?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                //insertToDatabase(current.fishImage, current.fishName, current.catName, current.sizeName, Integer.toString(current.price), current.providerName );

                                Snackbar.make(view, "Redirect to Edit item activity...", Snackbar.LENGTH_LONG).show();
                        ...
                        .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                Snackbar.make(view, "Edit item cancelled", Snackbar.LENGTH_LONG).show();
                            }
                        })//setNegativeButton
        ...
        myHolder.decline_button.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(final View view){
                ...
                AlertDialog myQuittingDialogBox = new AlertDialog.Builder(view.getContext())
                        //set message, title, and icon
                        .setTitle("Delete "+current.fishName)
                        .setMessage("Are you sure you want to delete "+ current.fishName + "?")
                        //.setIcon(R.drawable.icon) will replace icon with name of existing icon from project
                        //set two option buttons
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                Snackbar.make(view, "Deleting...", Snackbar.LENGTH_LONG).show();
                                //Set column of delivery status as cancelled
                        ...
                        .setNegativeButton("NO", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                Snackbar.make(view, "Delete Cancelled", Snackbar.LENGTH_LONG).show();
                            }
                        })//setNegativeButton
     ...
     */
    protected void insertToDatabase(final String order_img, String order_name, String order_cat, String order_size, String order_price, String provider_name){
        class  SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result){ //Will execute after the execution of doInBackground
                ...
                AlertDialog myInsertedDialogBox = new AlertDialog.Builder(context)
                        ...
                        .setMessage("Your delivery confirmation of " + result +  " has been sent")
                        //.setIcon(R.drawable.icon) will replace icon with name of existing icon from project
        ...
        sendPostReqAsyncTask.execute(order_img, order_name, order_cat, order_size, order_price, provider_name);
    }
